...
function datosPersonales (calle, numero, departamento, codigoPostal, ciudad, pais) {
    return "La dirección que ha ingresado es: " + " " + calle + " " +  numero + " " + departamento  + ", " +  codigoPostal + ", " + ciudad + ", " + pais + "."
}

console.log(datosPersonales("San Luis", 587, "2-B" ,7600,"Mar del plata","Argentina" ))
console.log(datosPersonales("San Martin", 1587, "PB" ,7600,"Mar del plata","Argentina" ))
console.log(datosPersonales("Rivadavia", 2267, "6-C" ,7600,"Mar del plata","Argentina" ))
...
function playlist (nombrePlaylist,cancion1,cancion2,cancion3) {
    return "Se ha creado la playlist " + nombrePlaylist + " con las canciones: " + cancion1 + ", " + cancion2 + ", " + cancion3 + "."
}

console.log(playlist("ROCK","Hotel California","Paranoid","En la ciudad de la furia"))
console.log(playlist("POP","Lonely","24K Magic","Your Song"))
console.log(playlist("REGUETON","Caramelo","Con calma","Se preparó"))
